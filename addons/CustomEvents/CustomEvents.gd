...
func _enter_tree():
	...
	add_custom_type("InputEventTrigger", "Node3D", preload("InputEventTrigger.gd"), preload("res://Sprites/UI/Kenny_input_prompts_pixel/Tiles (White)/tile_0000.png"))
...
func _exit_tree():
	...
	remove_custom_type("InputEventTrigger")
	pass
