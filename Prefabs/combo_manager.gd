...
var actionsDictionary = { #Keeps track of actions, their display name, and how much score they're worth
	...
	"died_tommytwotraps":["Fryer Fried",2000],
	"died_potatoshredz":["Fries With That?", 600],
	"died_burgz":["Patty Melted",700],
	"died_meatmecha": ["Nice 2 Meat U", 700],
	"died_npc":["Customer Served", 600],
	"died_worker":["Workers Chomp", 1000],
	"died_queez":["Mr Queez", 42069],
